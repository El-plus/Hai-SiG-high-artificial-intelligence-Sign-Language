...
$("#file-upload").change(function () {
	...
	if ($("#file-upload")[0].files[0] != undefined){
		confirm("Pastikan yang anda upload adalah fotos")
	}
});
...
$( document ).ready(async function () {
    ...
    model = await tf.loadLayersModel('https://raw.githubusercontent.com/AcqmalFadhilla/Model-HiSIGN/main/model.json');
	console.log(model);
